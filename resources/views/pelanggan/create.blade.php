<x-layout>
    <div class="page-shell-sm">
        ...
        <div class="surface-card">
            <form action="{{ route('pelanggan.store') }}" method="POST" class="form-shell">
                @csrf

                <div class="form-field">
                    <label class="field-label" for="nama_pelanggan">Nama pelanggan</label>
                    <input id="nama_pelanggan" type="text" name="nama_pelanggan" value="{{ old('nama_pelanggan') }}"
                ...
                <div class="form-field">
                    ...
                    <textarea id="alamat" name="alamat" class="form-textarea">{{ old('alamat') }}</textarea>
                </div>
