            ...
            <div class="flex items-center justify-end gap-3 lg:w-1/4">
                ...
                @else
                    <div class="hidden items-center gap-3 lg:flex">
                        <a href="{{ route('login') }}"
                            class="rounded-xl border border-blue-400 px-5 py-2.5 text-center text-sm font-bold text-slate-700 transition hover:border-blue-500 hover:shadow-lg hover:shadow-blue-400/30">Login</a>
            ...
            <div class="container mx-auto flex flex-col gap-3 px-4 py-4">
                ...
                @else
                    <div class="mt-2 flex flex-col gap-2 border-t border-slate-100 pt-4">
                        <a href="{{ route('login') }}"
                            class="block w-full rounded-xl border border-blue-500 px-5 py-3 text-center text-sm font-bold text-slate-700 transition hover:bg-slate-50">Login</a>
                        <a href="{{ route('register') }}"
