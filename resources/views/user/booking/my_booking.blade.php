                        ...
                        <div class="flex flex-col gap-6">
                            ...
                            @else
                                <div class="mt-6 rounded-[24px] border border-slate-100 bg-white p-6 shadow-sm">
                                    <div class="flex flex-col items-start gap-4 sm:flex-row">
                                        <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-slate-50 text-slate-400">
                                        ...
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm leading-6 text-slate-500">Saat ini tidak ada rekomendasi perbaikan tambahan dari mekanik.</p>
                                        </div>
                                    </div>
                                </div>
                            @endif
